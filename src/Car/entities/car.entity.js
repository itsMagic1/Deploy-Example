...
var Car = function () {
    ...
    var Car = _classThis = /** @class */ (function () {
        function Car_1() {
            ...
            this.modelo = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _modelo_initializers, void 0));
            ...
            this.owner = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _owner_initializers, void 0));
    ...
    (function () {
        ...
        _color_decorators = [(0, typeorm_1.Column)()];
        _owner_decorators = [(0, typeorm_1.ManyToOne)(function () { return Owner_entity_1.Owner; }, function (owner) { return owner.cars; })];
